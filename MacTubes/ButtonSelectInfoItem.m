#import "ButtonSelectInfoItem.h"

@implementation ButtonSelectInfoItem
...
- (void)awakeFromNib
{
	...
	[nc addObserver:self selector:@selector(handleControlBindArrayDidChanged:) name:CONTROL_NOTIF_INFO_ARRAY_DID_CHANGED object:nil];
...
- (IBAction)selectPlayItem:(id)sender
{
	// post notification
	NSNotificationCenter *nc = [NSNotificationCenter defaultCenter];
	[nc postNotificationName:CONTROL_NOTIF_INFO_SELECT_DID_CHANGED
